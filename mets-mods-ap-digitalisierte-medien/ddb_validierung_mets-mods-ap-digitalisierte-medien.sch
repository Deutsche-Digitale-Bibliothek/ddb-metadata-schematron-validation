...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
   ...
   <sch:pattern>
      <sch:rule context="mods:note[ancestor::mods:mods or ancestor::mods:physicalDescription][not(@type)]">
      ...
      <sch:rule context="mods:note[ancestor::mods:mods or ancestor::mods:physicalDescription][@type]">
